...
public class SampleWebView : MonoBehaviour
{
    ...
    [SerializeField] private Text NoInternet;
    [SerializeField] private GameObject ButtonsWeb;
    ...
    IEnumerator Start()
    {
        ...
        webViewObject.SetMargins(5, 300, 5, 300);
    ...
    public void CloseWeb()
    {
        ...
        ButtonsWeb.SetActive(false);
        SceneManager.LoadScene("Game");
    }

    private void Update()
    {
        if (webViewObject.Progress() == 0)
        {
 ...
 //       if (GUI.Button(new Rect(x, 100, 160, 130), "Перезагрузить")) {
 //           webViewObject.Reload();
 //       }
 //       x += 170;
...
//        if (GUI.Button(new Rect(x, 100, 160, 130), "Закрыть политику")) {
//            var g = GameObject.Find("WebViewObject");
//            if (g != null) {
//                Destroy(g);
//            } else {
